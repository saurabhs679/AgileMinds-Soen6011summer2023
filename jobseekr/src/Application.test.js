...
describe("Application Component", () => {
  ...
  it("renders the applications based on candidates list correctly", async () => {
    render(<Application />);
    ...
    expect(applicationElements).toHaveLength(2); // Assuming there are two jobs in the mockJobsData
  });
});
